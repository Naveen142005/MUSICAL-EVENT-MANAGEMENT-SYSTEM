...
def create_error(mes: str = "Error"):
    raise HTTPException(status_code=400, detail={"message": mes})
...
def validate_image_ex(file: UploadFile):
    """Validate if uploaded file is an image and within 5MB size"""
