...
from app.utils.common import format_ist
...
class DashboardService:
    ...
    def get_overview_stats(self, db: Session):
        ...
        escrow = db.query(func.sum(Escrow.released_amount).label("total")).first()
        
        escrow_amount = escrow.total
    ...
    def get_recent_activities(self, db: Session, limit: int):
        ...
        activities = db.query(
            ...
            Event.total_amount.label('amount')
        ...
        for a in activities:
            result.append({
                ...
                "timestamp":  format_ist( a.created_at )if a.created_at else None,
