...
'''
    This is router file used to test the websocket notification in the admin dashboard page.
    Whenever this routers called, the admin will get a notification via the socket connnection.
'''

router = APIRouter()

@router.get("/test/create_event")
...
@router.get("/test/reschedule_event")
...
@router.get("/test/pending_payment")
