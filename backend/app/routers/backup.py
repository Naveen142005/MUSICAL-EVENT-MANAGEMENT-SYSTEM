...
def restore_backup(file_id: str, current_user: dict = Depends(role_requires("Admin"))):
    """Download from Google Drive and restore database - Admin Only"""
