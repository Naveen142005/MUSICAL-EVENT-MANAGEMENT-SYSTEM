...
from app.schemas.content import AboutUsResponse, BandsResponse, FAQResponse, FooterResponse, HeroSectionResponse, VenueCaroselSection
from fastapi.datastructures import UploadFile as StarletteUploadFile

from app.utils.common import raise_exception, validate_image_ex
...
@router.get("/venue-carousel", response_model=VenueCaroselSection, status_code=status.HTTP_200_OK)
